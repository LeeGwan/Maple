...
private:
	...
	std::map<int, ID3D11ShaderResourceView* > RSkillAnimation1;

	std::map<int, ID3D11ShaderResourceView* > RSkillHitAnimation;
	Animation R_Skill_1;

	Animation R_Hit_Skill;
	Vec2 TMP1;
private:
	std::string RSkillAnimation1_Path;
	std::string RSkillHitAnimation_Path;
