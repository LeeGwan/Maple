...
private:
	...
	std::map<int, ID3D11ShaderResourceView* > ESkillAnimation1;

	std::map<int, ID3D11ShaderResourceView* > ESkillHitAnimation;
	Animation E_Skill_1;

	Animation E_Hit_Skill;
	Vec2 TMP1;
private:
	std::string ESkillAnimation1_Path;
	std::string ESkillHitAnimation_Path;
